...
export default function LandingPage (props) {
    ...
    return (
        ...
        <Grid item> {/*----The Revolution Block----*/}
            <Grid container justify="center" alignItems="center" style={{height:"70em", marginTop:"12em"}}>
                    ...
                    <CardContent>
                        <Grid container direction="column" style={{textAlign:"center"}}>
                            ...
                            <Grid item>
                                ...
                                <Button onClick={() => props.setValue(2)} component={Link} to="/revolution" className={classes.learnButtonHero} style={{marginTop: "1em"}} variant="outlined">
                                        <span style={{marginRight: 10}}>Learn More</span>
                                        <ButtonArrow width={15} height={15} fill={theme.palette.common.blue}/>
                                </Button>
                            </Grid>
        ...
        <Grid item> {/*----Information Block----*/}
           <Grid container className={classes.infoBackground} alignItems="center" style={{height:"70em"}}>
            ...
            <Grid item container style={{textAlign: matchesXS ? "center" : "inherit"}} direction={matchesXS ? "column" : "row"} >
                ...
                <Grid container direction="column" style={{marginBottom: matchesXS ? "10em" : 0}} >
                    ...
                    <Grid item>
                            <Button onClick={() => props.setValue(3)} component={Link} to="/about" style={{color:"white", borderColor: "white"}} variant="outlined" className={classes.learnButton}>
                                <span style={{marginRight: 10}}>Learn More</span>
                ...
                <Grid item sm style={{ marginTop: matchesXS ? "6em" : 0, marginRight: matchesXS ? 0 : matchesSM ? "2em" : "5em", textAlign: matchesXS ? "center" : "right"}}>
                <Grid container direction="column"  >
                    <Typography variant="h2" style={{color: "white"}}>Contact Us</Typography>
                    <Typography variant="subtitle2">Say hello! <span role="img" aria-label="waving hand">👋</span> </Typography>
                    <Grid item>
                            <Button onClick={() => props.setValue(4)} component={Link} to="/contact" style={{color:"white", borderColor: "white"}} variant="outlined" className={classes.learnButton}>
                                <span style={{marginRight: 10}}>Learn More</span>
                                <ButtonArrow width={10} height={10} fill="white"/>
                            </Button>
                    </Grid>
