  ...
  return (
    <Grid item container direction="column">
      ...
      >
        ...
        <Grid item style={{ alignSelf: "center" }} lg>
          <img
            ...
            alt="handshake"
            width="100%"
            style={{ maxWidth: 650, marginTop: matchesMD ? 0 : "5em" }}
          />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: "center" }} lg>
          <img
            ...
            width="100%"
            style={{ maxWidth: matchesMD ? 600 : 772 }}
          />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img
            ...
            width="100%"
            style={{ maxWidth: matchesMD ? "12em" : "25em" }}
          />
        </Grid>
      </Grid>
      ...
      <Grid
        ...
        justify="center"
        className={classes.rowContainer}
        style={{ backgroundColor: "#A67C52", height: "50em" }}
      >
        <Grid
          item
          container
      ...
      >
        ...
        <Grid item style={{ alignSelf: "center" }} lg>
          <img
            ...
            width="100%"
            style={{ maxWidth: matchesMD ? 700 : 850 }}
          />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img
            ...
            alt="rocket"
            style={{
              maxWidth: matchesMD ? 125 : 200,
              maxHeight: matchesMD ? 450 : 700,
            }}
            width="100%"
          />
        </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: "center" }} lg>
          <img
            ...
            width="100%"
            style={{ maxWidth: matchesMD ? 150 : 350 }}
          />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: "center" }} lg>
          <img
            ...
            width="100%"
            style={{ maxWidth: matchesMD ? 500 : 770 }}
          />
        </Grid>
      </Grid>
