...
import imtegrationsAnimation from "../animations/integrationAnimation/data.json";
...
export default function MobileApps(props) {
	...
	const defaultOptions = {
		loop: true,
		autoplay: true,
		animationData: imtegrationsAnimation,
		rendererSettings: {
	...
	return (
		<Grid container direction="column">
			...
			>
				<Grid item alignItems="center" container direction="column" md>
					<Grid item>
